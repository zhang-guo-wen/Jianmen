...
type AIAccessToken struct {
	...
	AccessTokenHash    string     `gorm:"uniqueIndex:idx_ai_tokens_access_hash_active,priority:1;size:64;not null" json:"-"`
	RefreshTokenHash   string     `gorm:"uniqueIndex:idx_ai_tokens_refresh_hash_active,priority:1;size:64;not null" json:"-"`
