...
func (s *Server) routes() http.Handler {
	...
	s.muxHandle(mux, "/api/ai/tokens", s.withAuthAndUser(s.withPermission(rbac.ActionAIManage, s.handleAITokens)))
	s.muxHandle(mux, "/api/ai/tokens/", s.withAuthAndUser(s.withPermission(rbac.ActionAIManage, s.handleAIToken)))
