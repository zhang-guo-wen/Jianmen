...
func bootstrapBuiltinPermissions(db *gorm.DB) error {
	permissions := []model.Permission{
		...
		{
			ID:          "builtin-db-view",
			Name:        "builtin-db-view",
			Action:      "db:view",
			Effect:      model.PermissionEffectAllow,
			Description: "Allows viewing the database management page.",
		},
		{
...
func bootstrapBuiltinRolePermissions(db *gorm.DB) error {
	assignments := []struct {
		...
		{builtinDBOperatorRoleID, "builtin-db-view"},
		...
		{builtinAdminRoleID, "builtin-db-view"},
		{builtinAdminRoleID, "builtin-ssh-connect"},
		{builtinAdminRoleID, "builtin-audit-view"},
