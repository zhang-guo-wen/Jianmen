...
func systemSettingUpdateColumns(setting model.SystemSetting) map[string]any {
	return map[string]any{
		...
		"ssh_redaction_enabled":             setting.SSHRedactionEnabled,
		"database_audit_redaction_enabled":  setting.DatabaseAuditRedactionEnabled,
		"database_audit_preview_bytes":      setting.DatabaseAuditPreviewBytes,
		"revision":                          setting.Revision,
		"updated_by":                        strings.TrimSpace(setting.UpdatedBy),
